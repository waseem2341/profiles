...
for i, stat in enumerate(statname):
    ...
    step=5 #step for time and altitude to reduce the umber of points!
    #data
    data[str(yyyy+mm+dd)]={}
    data[str(yyyy+mm+dd)]["z"]=Z[0:lidx_zmax:step].tolist() #needs to transform from array to list to be jsonified
